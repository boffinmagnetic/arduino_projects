...
void GameStep()
{
    ...
    case STATE_PLAY:
        ...
        if (ball.x > display.width() / 2 && ball_dir_x > 0)
        {
            if (paddle_2.y + 3 * paddle_2.h / 4 < (int)ball.y + ball.h / 2)
                paddle_2.y += PADDLE_SPEED;
            else if (paddle_2.y + paddle_2.h / 4 > (int)ball.y + ball.h / 2)
                paddle_2.y -= PADDLE_SPEED;
        }
        if (ball_dir_x < 0)
        {
            if (paddle_2.y + 3 * paddle_2.h / 4 < display.height() / 2)
                paddle_2.y += PADDLE_SPEED;
            else if (paddle_2.y + paddle_2.h / 4 > display.height() / 2)
                paddle_2.y -= PADDLE_SPEED;
        }
