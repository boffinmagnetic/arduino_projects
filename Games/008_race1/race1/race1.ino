...
void Draw()
{
    ...
    case STATE_PLAY:
        ...
        for (int16_t i = line_timer - 4; i < display.height(); i += 8)
        {
            display.drawLine(display.width() / 3, i, display.width() / 3, i + 3, 1);
            display.drawLine(display.width() * 2 / 3, i, display.width() * 2 / 3, i + 3, 1);
        }
...
void GameStep()
{
    ...
    case STATE_GAMEOVER:
        ...
        break;
    case STATE_PLAY:
        car.x = map(analogRead(Y_AXIS), 0, 700, 2, 0) * 21 + 3;
